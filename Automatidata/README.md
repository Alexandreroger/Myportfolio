![taxi in New York](Docs/0701211182685-web-tete.jpg)

# Predicting High Rider Gratuity: Insights for Taxi Drivers to Enhance Earnings

## Skills

**Python - Data cleaning - Data visualization - Multiple linear Model Regression - Random Forest Classification - Tableau**
...
<!-- ![Non-generous vs generous tippers]() -->
...
![Random ForestModel: Feature Importance](Docs/output.png)
